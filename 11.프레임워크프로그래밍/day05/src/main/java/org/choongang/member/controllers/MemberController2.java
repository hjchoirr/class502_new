...
public class MemberController2 {
    ...
    public String join(Model model) { //
        ...
        model.addAttribute("requestJoin", form); //join2.jsp 에 form에서 커맨드 객체 requestJoin  사용하므로 빈거라도 있어야
        return "member/join";
    }

    //private final Logger log = LoggerFactory.getLogger(MemberController2.class);
    @GetMapping("/join")

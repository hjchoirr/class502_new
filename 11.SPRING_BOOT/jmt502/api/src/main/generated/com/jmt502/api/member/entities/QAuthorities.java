...
public class QAuthorities extends EntityPathBase<Authorities> {
    ...
    private static final long serialVersionUID = 540771385L;

    private static final PathInits INITS = PathInits.DIRECT2;

    public static final QAuthorities authorities = new QAuthorities("authorities");

    public final EnumPath<com.jmt502.api.member.constants.Authority> authority = createEnum("authority", com.jmt502.api.member.constants.Authority.class);

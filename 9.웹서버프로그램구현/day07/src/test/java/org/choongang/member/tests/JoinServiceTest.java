...
public class JoinServiceTest {
    ...
    @Test
    @DisplayName("이메일 형식이 일치하지 않으면 BadRequestException 발생")
    ...
    @Test
    @DisplayName("필수항목입력(이메일, 비밀전호, 비밀번호확인, 회원명, 약관동의) 검증, 검증실페시 BadRequestException 발생")
    void requiredFieldTest() {
        ...
        assertAll(
                ...
                () -> requiredEachFieldTest("confirmPassword", true, "비밀번호확인"),
                () -> requiredEachFieldTest("confirmPassword", false, "비밀번호확인"),
    ...
    @Test
    @DisplayName("이미 가입된 메일인 경우 BadRequiredException 발생")
